...
namespace HNCDIExternalProjectManage
{
    ...
    partial void InsertPrizes(Prizes instance);
    partial void UpdatePrizes(Prizes instance);
    partial void DeletePrizes(Prizes instance);
    partial void InsertFunds(Funds instance);
    partial void UpdateFunds(Funds instance);
    partial void DeleteFunds(Funds instance);
    partial void InsertContractFunds(ContractFunds instance);
    partial void UpdateContractFunds(ContractFunds instance);
    partial void DeleteContractFunds(ContractFunds instance);
    #endregion
		...
		public System.Data.Linq.Table<Prizes> Prizes
		{
			get
			{
		...
		public System.Data.Linq.Table<ContractFunds> ContractFunds
		{
			get
			{
				return this.GetTable<ContractFunds>();
			}
		}
	}
	...
	public partial class FundClassify : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ContractFunds> _ContractFunds;
    ...
    partial void OnIncomeOrPayChanged();
		...
		public FundClassify()
		{
			...
			this._ContractFunds = new EntitySet<ContractFunds>(new Action<ContractFunds>(this.attach_ContractFunds), new Action<ContractFunds>(this.detach_ContractFunds));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FundClassify_ContractFunds", Storage="_ContractFunds", ThisKey="FandClassifyId", OtherKey="FundClassifyID")]
		public EntitySet<ContractFunds> ContractFunds
		{
			get
			{
				return this._ContractFunds;
			}
			set
			{
				this._ContractFunds.Assign(value);
			}
		}
		...
		private void attach_ContractFunds(ContractFunds entity)
		{
			this.SendPropertyChanging();
			entity.FundClassify = this;
		}
		
		private void detach_ContractFunds(ContractFunds entity)
		{
			this.SendPropertyChanging();
			entity.FundClassify = null;
		}
    ...
    partial void OnNoteChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProjectContracts_ContractFunds", Storage="_ContractFunds", ThisKey="ID", OtherKey="ContractID")]
		public EntitySet<ContractFunds> ContractFunds
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.ProjectContracts = this;
		}
		
		private void detach_ContractFunds(ContractFunds entity)
		{
			this.SendPropertyChanging();
			entity.ProjectContracts = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Prizes")]
	public partial class Prizes : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _DeclareDepartment;
		
		private string _AccountName;
		
		private string _Name;
		
		private string _PrizeClassify;
		
		private string _Project;
		
		private string _AwardName;
		
		private System.Nullable<decimal> _Prize;
    ...
    partial void OnDepartmentChanging(string value);
    partial void OnDepartmentChanged();
    partial void OnDeclareDepartmentChanging(string value);
    partial void OnDeclareDepartmentChanged();
    partial void OnAccountNameChanging(string value);
    partial void OnAccountNameChanged();
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnPrizeClassifyChanging(string value);
    partial void OnPrizeClassifyChanged();
    ...
    partial void OnPrizeChanging(System.Nullable<decimal> value);
    partial void OnPrizeChanged();
    partial void OnPayYearChanging(string value);
    partial void OnPayYearChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DeclareDepartment", DbType="NVarChar(50)")]
		public string DeclareDepartment
		{
			get
			{
				return this._DeclareDepartment;
			}
			set
			{
				if ((this._DeclareDepartment != value))
				{
					this.OnDeclareDepartmentChanging(value);
					this.SendPropertyChanging();
					this._DeclareDepartment = value;
					this.SendPropertyChanged("DeclareDepartment");
					this.OnDeclareDepartmentChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PrizeClassify", DbType="NVarChar(50)")]
		public string PrizeClassify
		{
			get
			{
				return this._PrizeClassify;
			}
			set
			{
				if ((this._PrizeClassify != value))
				{
					this.OnPrizeClassifyChanging(value);
					this.SendPropertyChanging();
					this._PrizeClassify = value;
					this.SendPropertyChanged("PrizeClassify");
					this.OnPrizeClassifyChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Project", DbType="NVarChar(256)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Prize", DbType="Money")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PayYear", DbType="NVarChar(4)")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ContractFunds")]
	public partial class ContractFunds : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<ProjectContracts> _ProjectContracts;
    ...
    partial void OnSubPrincipalChanged();
		...
		public ContractFunds()
		{
			this._FundClassify = default(EntityRef<FundClassify>);
			this._ProjectContracts = default(EntityRef<ProjectContracts>);
			OnCreated();
		}
		...
		public System.Nullable<int> ContractID
		{
			...
			set
			{
				...
				{
					if (this._ProjectContracts.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FundClassify_ContractFunds", Storage="_FundClassify", ThisKey="FundClassifyID", OtherKey="FandClassifyId", IsForeignKey=true, DeleteRule="SET NULL")]
		public FundClassify FundClassify
		{
			get
			{
			...
			set
			{
							...
							|| (this._FundClassify.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._FundClassify.Entity = null;
						previousValue.ContractFunds.Remove(this);
					}
					this._FundClassify.Entity = value;
					if ((value != null))
					{
						value.ContractFunds.Add(this);
						this._FundClassifyID = value.FandClassifyId;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProjectContracts_ContractFunds", Storage="_ProjectContracts", ThisKey="ContractID", OtherKey="ID", IsForeignKey=true, DeleteRule="SET NULL")]
		public ProjectContracts ProjectContracts
		{
			get
			{
				return this._ProjectContracts.Entity;
			}
			set
			{
				ProjectContracts previousValue = this._ProjectContracts.Entity;
				if (((previousValue != value) 
							|| (this._ProjectContracts.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ProjectContracts.Entity = null;
						previousValue.ContractFunds.Remove(this);
					}
					this._ProjectContracts.Entity = value;
					if ((value != null))
					{
						value.ContractFunds.Add(this);
					...
					this.SendPropertyChanged("ProjectContracts");
				}
			}
		}
